...
<article class="latestItemView" itemscope itemtype="http://schema.org/Article">
	...
	<header class="latestItemHeader">
	  ...
	  <!-- Item title -->
	  <h2 class="latestItemTitle" itemprop="name">
	...
	<div class="latestItemBody" itemprop="articleBody">
