...
<article class="itemlistItemView<?php echo ($this->item->featured) ? ' itemlistItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>" itemscope itemtype="http://schema.org/Article">
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest">
		<h3><?php echo JText::_('K2_LATEST_FROM'); ?> <span itemprop="author"><?php echo $this->item->author->name; ?></span></h3>
		<ul>
  ...
  <?php endif; ?>
	...
	<?php if($this->params->get('listItemCommentsAnchor') && $this->params->get('comments')): ?>
	<!-- Anchor link to comments below -->
	<div class="listItemCommentsLink">
	...
	<?php else: ?>
		...
		<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
			<span itemprop="commentCount"><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
		</a>
		<?php else: ?>
		<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
